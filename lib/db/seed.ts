...
// Shared id of the public demo project. The demo kit page, its asset files
// and its ZIP download are world-readable (linked from landing/nav/sitemap);
// everything else stays ownership-gated.
export const DEMO_PROJECT_ID = "demo_math_of_ai";
